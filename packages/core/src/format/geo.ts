...
export function fipsToName(fips: string): string | undefined {
  return STATE_FIPS[fips.padStart(2, '0')];
}

export function nameToAbbr(name: string): string | undefined {
  return STATE_ABBR[name];
}

export function abbrToName(abbr: string): string | undefined {
  return ABBR_TO_NAME[abbr.toUpperCase()];
}
